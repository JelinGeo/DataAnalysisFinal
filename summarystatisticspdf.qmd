...
table_data <- data.frame(
  Package = c("Base R", "dplyr", "skimr", "psych", "summarytools", "Hmisc", "pastecs", "mosaic", "gtsummary"),
  Key_Functions = c("summary(), mean(), sd()",
                    "summarise(), count()",
                    "skim()",
                    ...
                    "favstats(), tally()",
                    "tbl_summary()"),
  Strengths = c("Built-in, quick, basic, not pipeable",
                "Tidy, pipeable, flexible, group-wise summaries",
                "Tidy, detailed, sparkline histograms, missing data",
                "Skewness, kurtosis, group summaries",
                "HTML summaries, mini-histograms, missing data info",
                "Detailed, percentiles, unique values",
                "Wide range of stats, time series support",
                "Concise, teaching-focused",
                "Publication-ready tables, auto-detects variable types"),
  Use_Case = c("General, quick checks",
               "Custom summaries in tidyverse workflows",
               "Quick, detailed EDA",
               "In-depth descriptive stats",
               "Publication-ready summaries",
               "Medical, epidemiological data",
               "Broad, one-call summaries",
               "Teaching, quick summaries",
               "Medical, scientific reporting")
)

# Build the styled table
kable(table_data, format = "html", booktabs = TRUE, escape = FALSE,
      col.names = c("Package", "Key Function(s)", "Unique Features/Strengths", "Typical Use Case")) %>%
  kable_styling(full_width = FALSE, stripe_color = "#f2f2f2", bootstrap_options = c("striped", "bordered")) %>%
...
Next, load the Star Wars dataset available in the dylyr package. Read more on dylyr package here [@dplyr2023]
